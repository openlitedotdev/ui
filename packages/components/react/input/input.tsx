...
const Input = React.forwardRef<Comp, Props>(({ className, border, background, textsize, labeltext, type, ...props }, ref) => {
  return (
    <div className="relative flex flex-col-reverse">
      <input
        type={type}
        className={cn(input({ border, background, textsize }), className)}
        ref={ref}
        {...props}
      />
