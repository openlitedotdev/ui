import { Button, Slider, Table, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, TableRow } from '@openui-org/react'
        ...
        <Table>
          ...
          <TableBody>
            {invoices.map(invoice => (
              <TableRow key={invoice.invoice} className="relative">
